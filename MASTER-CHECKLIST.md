...
Owners: **F** = Founder · **AI** = AI assistant · **J** = Jhangir · **X** = External. Full role definitions: [08-TEAM/01-ROLES-AND-OWNERS.md](08-TEAM/01-ROLES-AND-OWNERS.md).
...
- [ ] **2. Sign the written partnership agreement with Jhangir** (IP assignment, roles, rev split ⚠ FOUNDER-DECISION, exit, credential protocol) — F+J · €200–2,000 · Day 1, **before any credential or IP sharing** · blocks: Seller Central access, §19 retrieval, talent sourcing → [01-PHASE-0-BLOCKERS/02-PARTNERSHIP-AGREEMENT.md](01-PHASE-0-BLOCKERS/02-PARTNERSHIP-AGREEMENT.md)
- [ ] **3. Register the Finnish business (toiminimi via ytj.fi)** — F · €75 · Day 1–3 (≈3–5 business days processing) · blocks: payment-provider applications, invoicing → [01-PHASE-0-BLOCKERS/03-BUSINESS-REGISTRATION-FINLAND.md](01-PHASE-0-BLOCKERS/03-BUSINESS-REGISTRATION-FINLAND.md)
...
- [ ] **5. Draft and publish privacy policy + terms** (AI drafts, founder reviews/publishes; EU-withdrawal-compliant refund terms) — F+AI · $0 · Week 1 · blocks: Paddle/Polar, CWS → same file as item 4
- [ ] **6. Open all service accounts** (CWS developer $5 + EU-DSA trader verification; fresh Supabase project; hosting; Gemini API paid tier; Wise Business; analytics) — F · ~$5–50 · Week 1 · blocks: build, payments, launch → [02-PHASE-1-FOUNDATION/01-ACCOUNTS-AND-SERVICES.md](02-PHASE-1-FOUNDATION/01-ACCOUNTS-AND-SERVICES.md)
- [ ] **7. Apply to BOTH Paddle and Polar** (behind the live site + legal pages); configure Appeal Pass $199 product — F · $0 · Week 1 · blocks: all revenue → [02-PHASE-1-FOUNDATION/03-PAYMENTS-SETUP.md](02-PHASE-1-FOUNDATION/03-PAYMENTS-SETUP.md)
...
- [ ] **11. Jhangir retrieves the full Amazon BSA §19 / Agent Policy text** (behind seller login) — J · $0 · before M-3 · blocks: any page-reading feature; injector decision → [07-REFERENCE/04-UNKNOWNS-REGISTER.md](07-REFERENCE/04-UNKNOWNS-REGISTER.md)
- [ ] **12. Run 5–8 paid audition orders with appeals experts** (on-platform gigs at $15–50 each, ~$75–400 total; fixture test with traps; expect 2–3 passers) — F+J · $75–400 · Week 2 · blocks: template quality → [08-TEAM/02-RECRUITMENT-KIT.md](08-TEAM/02-RECRUITMENT-KIT.md)
...
- [ ] **14. Run the Gate-1 checklist** (credentials rotated; agreement signed; toiminimi filed; payment applications submitted; domain + legal pages live; repo + CI green; fixture corpus underway). Kill criterion: both payment providers reject with no fallback operational within 48h → pause build.
...
- [ ] **23. GDPR operational kit** (Article 30 records, subprocessor DPAs, breach + data-subject-request procedures) — F(+X) · €0–1,000 · before first real user data (M-5) → [02-PHASE-1-FOUNDATION/02-DOMAIN-AND-LEGAL-PAGES.md](02-PHASE-1-FOUNDATION/02-DOMAIN-AND-LEGAL-PAGES.md)
...
- [ ] **30. Design-partner beta completes** (3 real cases decoded → drafted → exported; testimonials consented) — F+J · $0 · Week 7 → [04-PHASE-3-LAUNCH/03-DESIGN-PARTNER-BETA.md](04-PHASE-3-LAUNCH/03-DESIGN-PARTNER-BETA.md)
...
- [ ] **32. Public launch day** — follow the runbook — F+AI+J · $0 · Week 8 → [04-PHASE-3-LAUNCH/04-LAUNCH-DAY-CHECKLIST.md](04-PHASE-3-LAUNCH/04-LAUNCH-DAY-CHECKLIST.md)
...
- [ ] **36. Accountant engaged before first tax filing; VAT-threshold watch (€20k)** — F+X · ~€50–150/mo when engaged · Month 2+ → [06-OPERATIONS/04-PAYMENT-OPERATIONS.md](06-OPERATIONS/04-PAYMENT-OPERATIONS.md)
