...
- [ ] **3.** Create the support-sheet tags `agency-inquiry`, `bulk-inquiry`, `language-request`, `mobile-request`, `monitoring-request` and log every matching ticket. **Owner:** Founder (Jhangir may triage per `../06-OPERATIONS/01-SUPPORT-OPERATIONS.md`) · **Cost:** $0 · **Deadline:** before launch (M-7) · **Blocks:** demand evidence for all five personas.
