...
- [ ] **17. Weeks 4–5: web decoder + $199 composer LIVE on the domain** — the first revenue surface. **Before the checkout goes live, the revenue-critical Gate-3 checks must pass** (see item 31) — AI+F · hosting $0/mo pre-revenue (single-host Vercel + Supabase, corrected 11 Sep 2026 — was Cloudflare Pages + Supabase) · blocks: revenue, SEO, CWS-delay insurance → [04-PHASE-3-LAUNCH/01-WEB-DECODER-LAUNCH.md](04-PHASE-3-LAUNCH/01-WEB-DECODER-LAUNCH.md)
