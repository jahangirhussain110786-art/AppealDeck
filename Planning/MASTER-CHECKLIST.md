...
- [ ] **7. Apply to Paddle + open the Polar warm fallback** (behind the live site + legal pages; verify Polar's Pakistan payout at signup — Dodo Payments is plan-C); configure Appeal Pass $249 product — F · $0 · Week 1 · blocks: all revenue → [02-PHASE-1-FOUNDATION/03-PAYMENTS-SETUP.md](02-PHASE-1-FOUNDATION/03-PAYMENTS-SETUP.md)
...
- [ ] **17. Weeks 4–5: web decoder + $249 composer LIVE on the domain** — the first revenue surface. **Before the checkout goes live, the revenue-critical Gate-3 checks must pass** (see item 31) — AI+F · hosting $0/mo pre-revenue (single-host Vercel + Supabase, corrected 11 Sep 2026 — was Cloudflare Pages + Supabase) · blocks: revenue, SEO, CWS-delay insurance → [04-PHASE-3-LAUNCH/01-WEB-DECODER-LAUNCH.md](04-PHASE-3-LAUNCH/01-WEB-DECODER-LAUNCH.md)
...
- [ ] **35. Price test in the first ~20 sales** ($99/$149/$199) ⚠ FOUNDER-DECISION on design — F · $0 · first month → [07-REFERENCE/04-UNKNOWNS-REGISTER.md](07-REFERENCE/04-UNKNOWNS-REGISTER.md) **Superseded 21 Sep 2026 (commercial reset; gap D-03): the price is $249 flat, worldwide, and no price test is planned.**
