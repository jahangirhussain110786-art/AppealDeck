...
- **Why they churn:** v1 has no bulk anything. Fifty cases means fifty manual decode-intake cycles on one device. They will not attempt it twice. Per-case $249 pricing also inverts for them: at volume they want per-seat or per-account pricing.
