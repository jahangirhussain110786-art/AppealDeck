  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-16">
        <h1 className="text-3xl font-semibold text-gray-100">Refund &amp; withdrawal</h1>
        <div className="mt-6 space-y-4 text-sm text-gray-300">
          <p>
            <strong className="text-gray-100">7-day voluntary refund.</strong> If you have not redeemed your
            Appeal Pass, request a refund within 7 days for a full refund, no questions asked.
          </p>
          <p>
            <strong className="text-gray-100">EU/UK consumers.</strong> Where the law gives you a right to
