...
export const APP = {
  ...
  // 25 Sep 2026: the same names the case uses (EVIDENCE_KIND_LABELS in src/core/workspace.ts), so
  // one record is not called "Metric export" in the vault and "Sales or performance record" in the case.
  evidenceKinds: {
  ...
  dashboard: {
    // The v5 case list and greeting (26 Sep 2026). Every line is read from the seller's case.
    cases: {
      heading: "Your cases",
      open: "Open · {n}",
      closedTab: "Closed · {n}",
      ...
      reopen: "Reopen",
      closed: "Closed",
      noneClosed: "No closed cases.",
      noneOpen: "No open cases.",
      act: "You need to act",
      waiting: "Waiting",
      ...
      today: "Today",
      past: "Past",
      fromReceipt: "from the day you received the notice",
      openToContinue: "Open the case to continue.",
      replied: "Amazon replied. Read what it changes.",
      sent: "Sent {date}. Nothing to do until Amazon replies.",
      sentUndated: "Sent. Nothing to do until Amazon replies.",
      confirm: "Next: check how we read your notice",
      waitingFor: "Waiting for: {label}",
      review: "Next: {label}",
      write: "Next: write and check your response",
      finalReview: "Next: a final review before you send",
      headline: {
        none: "Start with",
        noneAccent: "your notice.",
        allClosed: "Every case is closed.",
