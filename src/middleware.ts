...
const APP_HOST = process.env.NEXT_PUBLIC_APP_HOST ?? "app.appealdeck.com";

const APP_PREFIXES = ["/app", "/auth"];
...
export function middleware(req: NextRequest) {
  ...
  // Local dev: treat localhost/127.0.0.1 as the app host so /app/* serves without redirect
