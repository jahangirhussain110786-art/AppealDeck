...
- **Last updated:** 5 Sep 2026 (evening — Wave B marketing surface complete: pricing table+FAQ+trust+consent+sample POA, legal pages rewrite with TOC, /faq route, OG image + manifest + apple-icon, copy audit AA-29)
